...
<style>
  .fp-h { font: 500 1.5rem/1.3 "Roboto", system-ui, sans-serif; margin: 0 0 1.5rem; color: var(--global-text-color, #000); }
  .fp {
    ...
    display: grid; grid-template-columns: minmax(220px, 330px) minmax(250px, 320px) minmax(200px, 1fr); gap: 24px 40px; align-items: start;
  }
  ...
  .fp-globe { width: 100%; aspect-ratio: 1; touch-action: none; cursor: grab; overflow: hidden; border-radius: 50%; background: var(--fp-card); display: block; }
  ...
  .fp-globe .tag rect { fill: none; stroke: none; }
  .fp-globe .tag text { font: 500 12.5px/1 "Roboto", sans-serif; fill: var(--fp-ink); paint-order: stroke; stroke: var(--fp-ocean); stroke-width: 4px; stroke-linejoin: round; }
  ...
  .fp-dna .rung { stroke-width: 2; stroke-linecap: round; opacity: .45; }
  .fp-dna .bub { cursor: pointer; }
  .fp-dna .bub circle.body { fill: var(--fp-card); stroke: var(--fp-strand); stroke-width: 1; }
  .fp-dna .bub:hover circle.body, .fp-dna .bub.on circle.body { stroke: var(--fp-accent); stroke-width: 2; }
  ...
  .fp-dna .bub .sat { fill: var(--fp-ink-2); }
  ...
  .fp-chr .outline { fill: var(--fp-card); stroke: var(--fp-ink); stroke-width: 1.4; }
  ...
  .fp-chr .sep { stroke: var(--fp-ink); stroke-width: .8; }
  ...
  .fp-card { position: absolute; left: 144px; right: 0; top: 0; display: grid; gap: 4px; padding: 0; transition: top .25s; }
  @media (prefers-reduced-motion: reduce) { .fp-card { transition: none; } }
  .fp-card b { font-size: 14px; font-weight: 500; color: var(--fp-ink); }
  .fp-card p { margin: 0; font-size: 13px; line-height: 1.6; color: var(--fp-ink-2); max-width: 34ch; }
